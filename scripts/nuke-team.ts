  ...
  const members = [
    {
      ...
      role: { fr: 'Chief Executive Officer', en: 'Chief Executive Officer' },
      bio: {
        fr: [{ _type: 'block', _key: 'k-bio-fr', style: 'normal', children: [{ _type: 'span', _key: 'k-bio-fr-s', text: 'Monsieur Kamal Alawo ADJAYI est le fondateur et CEO de Tychera Investments Ltd.', marks: [] }], markDefs: [] }],
    ...
    },
    {
      ...
      role: { fr: 'Chief Operating Officer', en: 'Chief Operating Officer' },
      bio: {
        fr: [{ _type: 'block', _key: 'h-bio-fr', style: 'normal', children: [{ _type: 'span', _key: 'h-bio-fr-s', text: 'Madame Hawa Kayisharaza est la COO de Tychera Investments Ltd.', marks: [] }], markDefs: [] }],
        en: [{ _type: 'block', _key: 'h-bio-en', style: 'normal', children: [{ _type: 'span', _key: 'h-bio-en-s', text: 'Ms. Hawa Kayisharaza is the COO of Tychera Investments Ltd.', marks: [] }], markDefs: [] }],
      },
      order: 2,
    },
  ]
